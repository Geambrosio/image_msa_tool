...
We validated results (see tool/validation) for plants and vertebrates and agreed that the MSA tool is a good estimator for MSA plants, but not for MSA vertebrates.
